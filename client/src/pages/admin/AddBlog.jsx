...
const [isPubliashed,setIsPublished] = useState(false);
  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll">
     ...
     <div className='flex gap-2 mt-4'>
      <p>Publish Now</p>
      <input type="checknox" checked={isPubliashed}className='scale-125 cursor-pointer' onChange={e=> setIsPublished(e.target.checked)}/>
     </div>
